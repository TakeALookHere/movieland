...
public abstract class RateCalculator {
    ...
    static double calculate(MovieRating userRating, double currentRating, long newVotesCount) {
        double newRatingNotRounded = (currentRating * (newVotesCount - 1) + userRating.getRating()) / newVotesCount;
